...
const JeffBrownLanding = () => {
  ...
  return <div className="min-h-screen">
      ...
      <section className="hero relative md:min-h-screen max-md:h-[60vh]">
        ...
        <div className="absolute bottom-[20%] left-[5%] z-40 md:lg:bottom-[18%] md:lg:left-[6%] lg:bottom-[20%] lg:left-[5%] max-md:bottom-[5%] max-md:left-[50%] max-md:transform max-md:-translate-x-1/2 max-md:translate-y-[60px] max-md:text-center max-md:w-full my-0 py-0 px-0 mx-[160px]">
      ...
      <div className="fixed bottom-4 left-4 right-4 z-50 bg-background/95 backdrop-blur-md border-2 border-border/50 rounded-2xl p-3 shadow-2xl shadow-black/20 md:hidden">
        <div className="flex flex-row gap-1">
          <div className="flex flex-row gap-1 flex-1">
            ...
            <button className="donate-button" style={{
