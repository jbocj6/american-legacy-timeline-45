...
const JeffBrownLanding = () => {
  ...
  const reformData = [{
    ...
    icon: <svg className="w-6 h-6 text-destructive" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return <div className="min-h-screen">
      ...
      <section className="hero relative md:min-h-screen max-md:h-[60vh]">
        ...
        <img src="/lovable-uploads/719ad38e-9ed6-4a9a-a1d1-f4e27b328670.png" alt="Jeff Brown Portrait" className="absolute right-[-15%] bottom-[-2%] h-[87vh] w-auto object-contain z-30 scale-110 
        ...
        <div className="absolute bottom-[20%] left-[5%] z-40 md:lg:bottom-[18%] md:lg:left-[6%] lg:bottom-[20%] lg:left-[5%] max-md:bottom-[5%] max-md:left-[50%] max-md:transform max-md:-translate-x-1/2 max-md:translate-y-[60px] max-md:text-center max-md:w-full py-0 px-0 mx-[160px] my-[111px]">
          <h1 className="text-8xl font-mono font-900 tracking-widest mb-4 text-white drop-shadow-lg md:lg:text-7xl md:lg:mb-3 lg:text-8xl lg:mb-4 max-md:!text-9xl max-md:mb-2 max-md:tracking-wider max-md:hero-text-outline max-sm:!text-8xl max-sm:mb-1 max-sm:tracking-wide py-0 my-px">
            Jeff Brown
          </h1>
        ...
        <div className="absolute bottom-8 right-8 z-50 flex gap-3 hero-social-mobile">
          {/* Instagram */}
          <a href="https://www.instagram.com/jeffreybrownj6/" target="_blank" rel="noopener noreferrer" className="p-3 bg-accent text-accent-foreground rounded-lg hover:bg-accent/80 transition-colors">
          ...
          {/* X (Twitter) */}
          <a href="https://x.com/jeffreybrownj6" target="_blank" rel="noopener noreferrer" className="p-3 bg-accent text-accent-foreground rounded-lg hover:bg-accent/80 transition-colors">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Truth Social */}
          <a href="https://truthsocial.com/@jeffreybrownj6" target="_blank" rel="noopener noreferrer" className="p-3 bg-accent text-accent-foreground rounded-lg hover:bg-accent/80 transition-colors">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Rumble */}
          <a href="https://rumble.com/user/Jeffreybrownj6" target="_blank" rel="noopener noreferrer" className="p-3 bg-accent text-accent-foreground rounded-lg hover:bg-accent/80 transition-colors">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="scroll-indicator z-50" onClick={() => document.querySelector('.reforms-section')?.scrollIntoView({
        behavior: 'smooth'
      })}>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="hidden md:block mb-8">
            ...
            <div className="md:lg:block lg:hidden">
              <div className="grid grid-cols-2 gap-5 max-w-4xl mx-auto">
                {reformData.map((reform, index) => <div key={index} className="bg-background/80 backdrop-blur-sm border border-destructive/20 rounded-xl p-5 hover:shadow-lg transition-all duration-300 hover:border-destructive/40 hover:bg-background/90 text-center">
            ...
            <div className="hidden lg:block">
              <div className="grid lg:grid-cols-3 gap-6 mb-6">
                {reformData.slice(0, 3).map((reform, index) => <div key={index} className="bg-background/80 backdrop-blur-sm border border-destructive/20 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:border-destructive/40 hover:bg-background/90 text-center">
              ...
              <div className="flex justify-center gap-6">
                {reformData.slice(3).map((reform, index) => <div key={index + 3} className="bg-background/80 backdrop-blur-sm border border-destructive/20 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:border-destructive/40 hover:bg-background/90 text-center w-full max-w-sm">
                    <div className="w-12 h-12 bg-destructive/10 rounded-lg flex items-center justify-center mb-4 mx-auto">
                      {reform.icon}
                    </div>
                    <h3 className="text-lg font-space font-semibold text-foreground mb-3">{reform.title}</h3>
          ...
          <div className="md:hidden mb-8">
            <Accordion type="multiple" className="space-y-4 max-md:!mt-0">
              {reformData.map((reform, index) => <AccordionItem key={index} value={`reform-${index}`} className="bg-background/80 backdrop-blur-sm border border-destructive/20 rounded-xl px-4 data-[state=open]:bg-background/90 transition-all duration-300 shadow-[0_0_20px_rgba(239,68,68,0.3)]">
      ...
      <section id="timeline" className="py-24 px-8 relative" ref={timelineRef}>
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="text-center mb-2">
            ...
            <div className="flex justify-center">
              <p className="text-2xl font-inter text-muted-foreground animate-fade-in
                         max-md:text-lg max-md:leading-relaxed
                         max-sm:text-base max-sm:leading-normal" style={{
                animationDelay: '1.2s'
              }}>
                The Road to Truth
              </p>
          ...
          <div className="relative">
            ...
            <svg className="absolute inset-0 w-full h-full md:hidden z-[-1]" viewBox="0 0 400 1000" preserveAspectRatio="none">
              <path id="treasure-trail" d="M200,80 L200,920" stroke="#dc2626" strokeWidth="4" fill="none" strokeLinecap="round" strokeDasharray="8 4" strokeDashoffset="840" className="animate-drawTreasureTrail" style={{
                animationDelay: '2s'
              }} />
            </svg>
            ...
            <div className="space-y-16 md:lg:space-y-12 lg:space-y-16 mt-8">
              {timelineEvents.map((event, index) => <div key={event.year} className={`timeline-item relative animate-fade-in z-10
                     md:lg:flex md:lg:items-start md:lg:flex-row
                     lg:flex lg:items-center
                     ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}
                     flex flex-col
                   `} style={{
                animationDelay: `${index * 0.3 + 1.8}s`
              }}>
                  ...
                  `}>
                    <div className="bg-card border border-border/50 rounded-2xl p-6 md:lg:p-6 lg:p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:border-accent/50 transform hover:-translate-y-2 group relative overflow-hidden">
                      ...
                      <div className={`absolute top-1/2 transform -translate-y-1/2 w-8 h-0.5 bg-gradient-to-r from-primary to-accent hidden lg:block ${index % 2 === 0 ? '-left-8' : '-right-8'}`}></div>
                      ...
                      <div className="relative z-10">
                        <img src={event.image} alt={event.title} className="w-full h-40 md:lg:h-36 lg:h-48 object-cover rounded-xl mb-4 md:lg:mb-4 lg:mb-6 transition-transform duration-300 group-hover:scale-105" />
                        <h3 className={`
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="hidden md:block mb-12">
            ...
            <div className="md:lg:block lg:hidden">
              <div className="grid grid-cols-2 gap-6 mb-6 max-w-3xl mx-auto">
                {policyData.slice(0, 2).map((policy, index) => <div key={index} className="bg-background/80 backdrop-blur-sm border border-primary/20 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:border-primary/40 hover:bg-background/90 text-center">
            ...
            <div className="hidden lg:grid lg:grid-cols-3 gap-6">
              {policyData.map((policy, index) => <div key={index} className="bg-background/80 backdrop-blur-sm border border-primary/20 rounded-xl p-8 hover:shadow-lg transition-all duration-300 hover:border-primary/40 hover:bg-background/90 text-center">
          ...
          <div className="md:hidden mb-12">
            <Accordion type="multiple" className="space-y-4">
              {policyData.map((policy, index) => <AccordionItem key={index} value={`policy-${index}`} className="bg-background/80 backdrop-blur-sm border border-primary/20 rounded-xl px-4 data-[state=open]:bg-background/90 transition-all duration-300 shadow-[0_0_20px_rgba(59,130,246,0.3)]">
                  <AccordionTrigger className="font-space font-semibold text-foreground hover:no-underline py-4 text-left max-md:!text-sm [&[data-state=open]>svg]:rotate-180">
                    <div className="flex items-center gap-3">
          ...
          <div className="text-center">
            <button onClick={() => setIsDonateModalOpen(true)} className="donate-button mr-4">
      ...
      <footer className="relative py-20 text-center overflow-hidden">
        ...
        <div className="relative z-10 text-white">
          ...
          <div className="relative mb-8 max-w-3xl mx-auto">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-accent/20 via-primary/20 to-accent/20 rounded-xl blur-lg animate-pulse" style={{
              ...
              <div className="text-center">
                <div className="flex flex-col sm:flex-row gap-8 items-center justify-center">
                  ...
                  <div className="qr-card group">
                    <a href="https://cash.app/$JeffreyBrownJ6?qr=1" target="_blank" rel="noopener noreferrer">
                      <img src="/lovable-uploads/420ff39e-62d5-4c12-9574-d84f02460858.png" alt="Cash App QR Code" className="w-32 h-32 sm:w-40 sm:h-40 object-contain rounded-lg transition-all duration-300 group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-primary/30 cursor-pointer" style={{
                  ...
                  <div className="qr-card group">
                    <a href="https://account.venmo.com/u/JeffreyBrownJ6" target="_blank" rel="noopener noreferrer">
                      <img src="/lovable-uploads/47b0e0a6-ce08-4dfa-9fee-8c3770a6a8b9.png" alt="Venmo QR Code" className="w-32 h-32 sm:w-40 sm:h-40 object-contain rounded-lg transition-all duration-300 group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-primary/30 cursor-pointer" style={{
                        imageRendering: 'crisp-edges'
                      }} />
                    </a>
                  </div>
                  ...
                  <div className="qr-card group">
                    <a href="https://www.givesendgo.com/theroadforward" target="_blank" rel="noopener noreferrer">
                      <img src="/lovable-uploads/abb6f57c-b8f2-4420-9f1c-ccb0b4d313a2.png" alt="Give Send Go QR Code" className="w-32 h-32 sm:w-40 sm:h-40 object-contain rounded-lg transition-all duration-300 group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-primary/30 cursor-pointer" style={{
                        imageRendering: 'crisp-edges'
                      }} />
                    </a>
                  </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <a href="https://calendly.com/bhogan-revgenengines/30min" target="_blank" rel="noopener noreferrer" className="donate-button max-sm:w-[280px]" style={{
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-4 text-sm">
            <a href="/terms-conditions" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors duration-200 underline underline-offset-4">
              Terms & Conditions
            </a>
            <span className="text-muted-foreground">•</span>
            <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors duration-200 underline underline-offset-4">
              Privacy Policy
            </a>
          </div>
        </div>
      ...
      <div className="fixed bottom-4 left-4 right-4 z-50 bg-background/95 backdrop-blur-md border-2 border-border/50 rounded-2xl p-3 shadow-2xl shadow-black/20 md:hidden">
        <div className="flex flex-col md:flex-row gap-1 md:gap-4">
          <button onClick={() => setIsDonateModalOpen(true)} className="donate-button" style={{
          ...
          <a href="https://calendly.com/bhogan-revgenengines/30min" target="_blank" rel="noopener noreferrer" className="donate-button" style={{
          background: 'white',
          color: 'black',
          border: '2px solid white',
          boxShadow: '0 0 20px rgba(255,255,255,0.2)',
