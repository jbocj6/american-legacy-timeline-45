                ...
                <div className="relative z-10">
                  ...
                  <div className="grid lg:grid-cols-3 gap-6 items-center">
                    ...
                    <div className="relative text-center">
                      <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 bg-red-500/95 text-white px-4 py-2 rounded-full text-2xl font-bold border-2 border-white/30" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.5)'}}>
                        99% DROP
                      </div>
