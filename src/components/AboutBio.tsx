...
const AboutBio = () => {
  ...
  return (
    <section id="meet-jeff" className="py-24 px-8 max-md:py-16 max-md:px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center max-md:grid-cols-1 max-md:gap-8">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-6xl font-space font-bold text-foreground mb-6 max-md:text-4xl max-md:mb-4 max-sm:text-3xl max-sm:mb-3 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Meet Jeff Brown</h2>
