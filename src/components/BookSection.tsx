          ...
          <div className="relative">
            ...
            <div className="mb-6 text-center">
              <img 
                ...
                className="w-full max-w-xs mx-auto h-auto rounded-lg shadow-xl border-4 border-primary"
              />
            </div>
            ...
            <div className="md:hidden">
              <Accordion type="multiple" className="space-y-4">
                {bookExcerpts.map((excerpt, index) => (
                  ...
                  >
                    <AccordionTrigger className="font-space font-semibold text-foreground hover:no-underline py-4 text-left max-md:text-lg max-md:font-semibold [&[data-state=open]>svg]:rotate-180">
                      {excerpt.title}
                    </AccordionTrigger>
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button 
              variant="outline" 
              onClick={() => window.open('https://btapcsve.manussite.space/', '_blank')}
              className="min-w-[260px] h-14 px-10 text-lg border-2 border-accent text-accent hover:bg-accent hover:text-accent-foreground"
            >
